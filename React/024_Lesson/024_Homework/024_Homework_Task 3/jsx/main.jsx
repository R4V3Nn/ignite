...
var View3 = require('./views/view3.jsx');
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="panel">{/* использование ReactCSSTransitionGroup для запуска анимации */}
...
ReactDOM.render(
    <Router history={hashHistory}>
        <Route path='/' component={App}>
            ...
            <Route path="listView/:id" component={View3} />
            <Route path="tableView/:id" component={View3} />
            <Redirect from="*" to="/" />
        </Route>
